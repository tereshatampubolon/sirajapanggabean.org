        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $groupsUser->has('user') ? $this->Html->link($groupsUser->user->username, ['controller' => 'Users', 'action' => 'view', $groupsUser->user->id]) : '' ?></td>
                    <td><?= h($groupsUser->created) ?></td>
                    <td><?= h($groupsUser->user_created) ?></td>
                    <td><?= h($groupsUser->ip_created) ?></td>
                    <td><?= h($groupsUser->modified) ?></td>
                    <td><?= h($groupsUser->user_modified) ?></td>
                    <td><?= h($groupsUser->ip_modified) ?></td>
                    <td class="actions">
