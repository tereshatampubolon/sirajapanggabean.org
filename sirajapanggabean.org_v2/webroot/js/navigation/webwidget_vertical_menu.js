(function(a){
    a.fn.webwidget_vertical_menu=function(p){
        ...
        var l=p&&p.menu_width?p.menu_width:"298";
        ...
        function init(){
            ...
            w.children("ul").children("li").find("ul").css("width",250).css("left",298).css("top","0px");
			//w.children("ul").children("li.list_child").find("ul").css("width",100).css("left",100).css("top","0px");
			$('li.list_Child').find("ul").css("width",250).css("left",250).css("top","0px");
			w.children("ul").children("li").children("ul").find("li").css("width",250);
        }
