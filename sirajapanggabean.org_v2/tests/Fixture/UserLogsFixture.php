...
class UserLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'session_id' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'login_date' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => false, 'default' => null, 'comment' => ''],
        'last_access' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => ''],
        'logout_date' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'login_date' => '2020-06-23 03:46:57',
                'last_access' => '2020-06-23 03:46:57',
                'logout_date' => '2020-06-23 03:46:57',
                'created' => '2020-06-23 03:46:57',
                'user_created' => 'Lorem ipsum dolor sit amet',
                'ip_created' => 'Lorem ipsum d',
                'modified' => '2020-06-23 03:46:57',
