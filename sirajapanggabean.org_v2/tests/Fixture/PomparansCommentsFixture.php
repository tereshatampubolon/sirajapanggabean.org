...
/**
 * PomparansCommentsFixture
 */
class PomparansCommentsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        're_comment' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                're_comment' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'status' => 1,
                'created' => '2020-06-22 15:28:17',
                'user_created' => 'Lorem ipsum dolor sit amet',
                'ip_created' => 'Lorem ipsum dolor sit amet',
                'modified' => '2020-06-22 15:28:17',
