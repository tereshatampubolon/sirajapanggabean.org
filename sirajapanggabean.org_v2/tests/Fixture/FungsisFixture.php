 ...
 * FungsisFixture
 */
class FungsisFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'fungsi' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'module_id' => 1,
                'group_id' => 1,
                'fungsi' => 'Lorem ipsum dolor sit amet',
                'blocked' => 1,
                'created' => '2020-06-23 03:34:14',
                'user_created' => 'Lorem ipsum dolor sit amet',
                'ip_created' => 'Lorem ipsum d',
                'modified' => '2020-06-23 03:34:14',
